...
if '__main__' == __name__:
    import sys
    sys.path.append('/afs/cern.ch/work/c/christiw/programs/MG5_aMC_v2_6_4')
import misc
import logging
import gzip
...
if '__main__' == __name__:   
	...
	assert len(sys.argv)==4
 	if not len(sys.argv)==4:
	    print("format: python lhe_parse.py unweighted_events.lhe.gz output_events.lhe vtim")
        start = time
        lhe = EventFile(str(sys.argv[1]))
	...
	#write the banner to the output file
		...
		# modify particle attribute: here remove the mass
                if particle.pid ==9000006 or particle.pid == 9000007:
