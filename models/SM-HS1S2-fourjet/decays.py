...
Decay_SS2 = Decay(name = 'Decay_SS2',
                  particle = P.SS2,
                  partial_widths = {(P.b,P.b__tilde__):'((-24*gS2**2*MB**2 + 6*gS2**2*MSS2**2)*cmath.sqrt(-4*MB**2*MSS2**2 + MSS2**4))/(16.*cmath.pi*abs(MSS2)**3)',
                                    (P.c,P.c__tilde__):'(3*gS2**2*MSS2**4)/(8.*cmath.pi*abs(MSS2)**3)',
                                    (P.d,P.d__tilde__):'(3*gS2**2*MSS2**4)/(8.*cmath.pi*abs(MSS2)**3)',
                                    (P.e__minus__,P.e__plus__):'(gS2**2*MSS2**4)/(8.*cmath.pi*abs(MSS2)**3)',
                                    (P.H,P.SS1):'(gHSS**2*cmath.sqrt(MH**4 - 2*MH**2*MSS1**2 + MSS1**4 - 2*MH**2*MSS2**2 - 2*MSS1**2*MSS2**2 + MSS2**4))/(16.*cmath.pi*abs(MSS2)**3)',
                                    (P.mu__minus__,P.mu__plus__):'(gS2**2*MSS2**4)/(8.*cmath.pi*abs(MSS2)**3)',
                                    (P.s,P.s__tilde__):'(3*gS2**2*MSS2**4)/(8.*cmath.pi*abs(MSS2)**3)',
                                    (P.t,P.t__tilde__):'((6*gS2**2*MSS2**2 - 24*gS2**2*MT**2)*cmath.sqrt(MSS2**4 - 4*MSS2**2*MT**2))/(16.*cmath.pi*abs(MSS2)**3)',
                                    (P.ta__minus__,P.ta__plus__):'((2*gS2**2*MSS2**2 - 8*gS2**2*MTA**2)*cmath.sqrt(MSS2**4 - 4*MSS2**2*MTA**2))/(16.*cmath.pi*abs(MSS2)**3)',
                                    (P.u,P.u__tilde__):'(3*gS2**2*MSS2**4)/(8.*cmath.pi*abs(MSS2)**3)',
